...
/**
 * 自定义二次排序
 * 1.实现自定义的key，要实现Ordered和Serializable接口，在key中实现自己对多个列的排序算法
 * 2.将包含文本的RDD，映射成key为自定义，value为文本的JavaPairRDD
...
public class SecondarySort {
	public static void main(String[] args) {
		...
		JavaRDD<String> lines = sc.textFile("/Users/alanwang/Documents/Work/textFile/sort.txt");
